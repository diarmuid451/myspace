...
public class InitBeanListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent ctxEvent) {
    	...
    	String sqlSFType = ctxEvent.getServletContext().getInitParameter("sqlSessionFactory");
...
//    	String attachDao = ctxEvent.getServletContext().getInitParameter("attachDAO");
    	...
    	String memberservice = ctxEvent.getServletContext().getInitParameter("memberService");
    	String boardservice = ctxEvent.getServletContext().getInitParameter("boardService");
    	String replyservice = ctxEvent.getServletContext().getInitParameter("replyService");
//    	String pdsService = ctxEvent.getServletContext().getInitParameter("pdsService");    	
//    	String attachService = ctxEvent.getServletContext().getInitParameter("attachService");
...
//		PdsService pdsDAO =null;
//		AttachService attachDAO =null;
...
//				attachDAO = (AttachDAO)Class.forName(attachDao).newInstance();
				...
				memberService = (MemberService)Class.forName(memberservice).newInstance();
				
				boardService = (BoardService)Class.forName(boardservice).newInstance();
			
				replyService = (ReplyService)Class.forName(replyservice).newInstance();
			} catch (Exception e){
				e.printStackTrace();
